...
export function BrandPanel() {
  return (
    <div className="bg-navy-dark text-white flex flex-col justify-between p-[clamp(40px,6vw,80px)] relative overflow-hidden min-h-screen">
      <Link href="/" className="font-serif text-[28px] font-bold text-gold tracking-[0.06em] no-underline">ThickApparel</Link>
      <div>
        ...
        <p className="text-sm text-white/60 max-w-[340px] leading-[1.9] mb-9">Bergabunglah dengan 50.000+ pelanggan ThickApparel dan nikmati akses eksklusif ke koleksi terbaru, penawaran spesial, dan pengalaman berbelanja yang menyenangkan.</p>
      ...
      <div>
        <PlaceholderImage src="https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1200&q=80" alt="ThickApparel campaign" label={"campaign image\nlookbook foto"} sizes="(max-width: 1024px) 100vw, 40vw" className="w-full h-[180px] opacity-70" />
